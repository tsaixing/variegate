...
export default class PlantDetailPage extends Component {
  render() {
        ...
        <main class="grid place-items-center h-screen bg-gray-100">
          <section class="flex flex-col md:flex-row gap-11 py-10 px-5 bg-white rounded-md shadow-lg w-3/4 md:max-w-2xl">
            ...
            <div class="text-indigo-500">
              ...
              <small class="text-black">The Nike Epic React Flyknit 1 provides crazy comfort that lasts as long as you
                can
                run. Its Nike React foam cushioning is responsive yet lightweight, durable yet soft. This attraction of
                opposites creates a sensation that not only enhances the feeling of moving forwards, but makes running
                feel fun, too.</small>
